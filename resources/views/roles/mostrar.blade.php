...
<header class="bg-white shadow">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">Los datos del rol son:</h1>
    </div>
</header> 
<!-- component -->
...
py-1 px-2 border border-green-500 rounded"><a href="{{route('role.principal') }}">Volver</a></button>  
